...
func resourceLtsStructTemplateCreate(ctx context.Context, d *schema.ResourceData, meta interface{}) diag.Diagnostics {
	...
	client.WidthMethod(httpclient_go.MethodPost).WithUrl(url).WithHeader(header).WithBody(structTemplateRequest)
	response, err := client.Do()
	if err != nil {
		return diag.Errorf("error request creating StructTemplate fields %s: %s", structTemplateRequest, err)
	}
	...
	return diag.Errorf("error creating StructTemplate fields %s: %s, %d", structTemplateRequest, err)
}
...
func resourceLtsStructTemplateDelete(_ context.Context, d *schema.ResourceData, meta interface{}) diag.Diagnostics {
	...
	client.WidthMethod(httpclient_go.MethodDelete).WithUrl(url).WithHeader(header).WithBody(structTemplateDeleteRequest)
	resp, err := client.Do()
	if err != nil {
...
func resourceLtsStructTemplateUpdate(ctx context.Context, d *schema.ResourceData, meta interface{}) diag.Diagnostics {
	...
	client.WidthMethod(httpclient_go.MethodPut).WithUrl(url).WithHeader(header).WithBody(structTemplateRequest)
	response, err := client.Do()
	if err != nil {
